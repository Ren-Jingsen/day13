...
# 发送者的登陆用户名和密码(授权码)
user = '2876188845@qq.com'
password = 'udkylbwgsrahdhai'  # 授权码
# 发送的内容
# send_message = 'hello,send by Python.....'
# 发送者邮箱
sender = '2876188845@qq.com'
# 接收者的邮箱地址
receiver = ['2876188845@qq.com']  # receiver 可以是一个list
...
msg['From'] = Header('任晶森', 'utf-8')  # 发件人
msg['To'] = Header('2876188845@qq.com', 'utf-8')  # 收件人
msg['Subject'] = Header('计算器测试报告-任晶森', 'utf-8')  # 主题

# 构造附件1，传送当前目录下的111.jpg文件
file = open('计算机测试报告.html', 'rb')  # 读取附件内容
fr = file.read()
att1 = MIMEText(fr, 'base64', 'utf-8')
# 设置 filename 文件名
att1.add_header('Content-Disposition', 'attachment', filename="计算器报告.html")
msg.attach(att1)
